...
You will not be able to decipher the text inside the node, but the idea is to give you a sense of how a shiny application with module can be organized and split into smaller pieces that are all related to each other in a tree form.
...
We recommend defining two kind of developers: a unique person (or maybe two) to be in charge of supervising the whole project and developers that will work on specific features.
...
We strongly suggest using git with a graphical interface (GitLab, GitHub, Bitbucket, ...), as the graphical interface of these services will help you manage the project.
